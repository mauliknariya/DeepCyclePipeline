...
parser.add_argument('--base_gene', type=str, required=False, default=None, help='Gene used to have an initial guess of the phase.')
...
parser.add_argument('--output_adata', type=str, required=False, default='deepcycle.h5ad', help='Anndata output file.')
parser.add_argument('--output_dir', type=str, required=False, default=os.getcwd()+'/DeepCycle', help='')
...
if base_gene is None:
    if 'Nusap1' in genes:
        base_gene = 'Nusap1'
    elif 'NUSAP1' in genes:
        base_gene = 'NUSAP1'
    else:
        base_gene = np.random.choice(genes)
        
print ("Used %s as the base gene"%base_gene)    
...
adata.write_h5ad('%s/%s'%(args.output_dir, output_anndata_file))
